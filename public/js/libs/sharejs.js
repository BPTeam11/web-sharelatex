define(["ace/ace"], function() {
	(function() {
  var Doc, MicroEvent, Range, WEB, append, applyToShareJS, bootstrapTransform, checkValidComponent, checkValidOp, exports, invertComponent, nextTick, strInject, text, transformComponent, transformPosition, types,
    __slice = [].slice,
  ...
  Doc = (function() {
    ...
    Doc.prototype.open = function(callback) {
      ...
      this.state = 'opening';
      return this._openCallback = (function(_this) {
  ...
  applyToShareJS = function(editorDoc, delta, doc) {
    var getStartOffsetPosition, pos;
